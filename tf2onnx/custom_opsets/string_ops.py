...
class StringOps:
    ...
    def version_1(cls, ctx, node, **kwargs):
        ...
        skip_empty_const = ctx.make_const(utils.make_name('skip_empty_const'), np.array([skip_empty], np.bool_))
...
class StaticRegexReplace:
    ...
    def version_1(cls, ctx, node, **kwargs):
        ...
        pattern_node = ctx.make_const(utils.make_name("pattern"), np.array([pattern], np.object_))
        rewrite_node = ctx.make_const(utils.make_name("rewrite"), np.array([rewrite], np.object_))
...
class StringJoin:
    ...
    def version_1(cls, ctx, node, **kwargs):
        ...
        separator_node = ctx.make_const(utils.make_name("separator"), np.array([separator], np.object_))
